...
namespace FeintTemplateEngine.Plugins
{
    class HtmlTagPlugin : TemplatePlugin
    {
            ...
            : base(renderer)
        {
            ...
            base.RegularExpressionPatterns.Add("^" + tagNamePattern + classPattern + idPattern + attributes + "( ?(?<text>[^\\(]*.*)|$)$");
            base.RegularExpressionPatterns.Add("^" + tagNamePattern + classPattern + idPattern +attributes+ "?.[w]*$");
            base.RegularExpressionPatterns.Add("^" + tagNamePattern + idPattern + classPattern + attributes + "?.[w]*$");
